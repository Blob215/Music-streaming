...
<nav class="navbar navbar-inverse" style="background-color:#000000; class='font-family: 'Times New Roman', Times, serif;">
    <div class = "container-fluid">
        <ul class="nav">
            ...
            <li class="nav"><a href="settings.php" style="color: #ffffff">Settings</a></li>
        
            <li class="nav"><a href="search.php" style="color: #ffffff">Search</a></li>
            
            <li class="nav"><a href="foryou.php" style="color: #ffffff">For you</a></li>
        </ul>
    </div>
    </nav>
